...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(704, 174);
			...
			this->textBox1->Size = System::Drawing::Size(854, 22);
			this->textBox1->TabIndex = 1;
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &MyForm::textBox1_TextChanged);
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(11, 114);
			this->textBox2->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->textBox2->Name = L"textBox2";
			this->textBox2->ReadOnly = true;
			this->textBox2->Size = System::Drawing::Size(855, 22);
			...
			this->label2->Size = System::Drawing::Size(569, 17);
			...
			this->ClientSize = System::Drawing::Size(876, 228);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		textBox1->Text = "";
		int arr[10] = {2, 16, 21, 41, 65, 13, 6, 48, 50, 34};
		char arrBit[10][8];
		char elemBit[8];
		int k;
		bool flag[10];
